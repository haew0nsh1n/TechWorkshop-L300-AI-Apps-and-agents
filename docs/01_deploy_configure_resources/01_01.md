...
aiFoundryName="aif-umqut7mmjgn76"
...
aiProjectName="proj-umqut7mmjgn76"
```

Once you have these variables set, run the following commands. This script first retrieves the principal ID of the signed-in user, then enables the system-assigned managed identity for the Azure AI Search resource. After that, it retrieves the principal ID of the managed identity and assigns the necessary roles to both the signed-in user and the managed identity to allow access to Cosmos DB and Azure AI Foundry.
